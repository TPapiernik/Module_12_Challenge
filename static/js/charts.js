// charts.js
// [Updated from local copy to refer to samples.json hosted on GitHub Pages]
...
function init() {
  ...
  d3.json("https://tpapiernik.github.io/Module_12_Challenge/static/js/samples.json").then((data) => {
...
function buildCharts(sample) {
  ...
  d3.json("https://tpapiernik.github.io/Module_12_Challenge/static/js/samples.json").then((data) => {
    ...
    var barLayout = {
      title: `Top 10 Bacterial Cultures Found [Test Subject ${sample}]`
    };
